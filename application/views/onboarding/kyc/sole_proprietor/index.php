...
<body>
  ...
  <div class="kyc-wrap">
    ...
    <div class="screen" id="screen-manual">
      <div class="manual-container">
        ...
        <div class="doc-card" id="panCard">
          <div class="doc-card-head">
            <div class="doc-head-left">
              ...
              <div>
                <div class="doc-title">PAN Card <span class="badge-mandatory">Mandatory</span></div>
            ...
            <div class="doc-form">
              ...
              <div id="panDynamicFields">
                ...
                <div class="form-row"><label class="form-label">PAN Number <span>*</span></label><input
                    class="form-input" type="text" id="panNumber" placeholder="Enter PAN Number" oninput="checkManualReady()">
                </div>
        ...
        <div class="doc-card" id="soleAddrCard">
          <div class="doc-card-head">
            <div class="doc-head-left">
              <div class="doc-icon" id="soleAddrIconEl"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                  stroke-width="2">
            ...
            <div id="soleAddrCheck" style="display:none;" class="doc-check"><svg viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2.5">
                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
                <polyline points="22,4 12,14.01 9,11.01" />
              </svg></div>
          ...
          <div style="padding: 0 24px 20px;">
            <label class="form-label">Select Business Proof <span>*</span></label>
            <select class="form-select" id="addrDocType" onchange="onAddrTypeChange()">
              <option value="" disabled selected>Choose document type</option>
              <option value="shop">Shop Establishment Certificate</option>
              <option value="udyam">UDYAM Aadhaar</option>
            </select>
          </div>

          <div id="soleAddrUploadZone" style="display:none;">
            <div class="upload-zone" onclick="document.getElementById('soleAddrFileInput').click()">
              <div class="upload-zone-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="16,16 12,12 8,16" />
                  <line x1="12" y1="12" x2="12" y2="21" />
                  <path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3" />
                </svg></div>
              <div class="upload-zone-text" id="addrUploadLabel">Click to upload Business/Address Proof</div>
              <div class="upload-zone-hint">PNG, JPG or PDF (max. 5MB)</div>
            </div>
            <input type="file" id="soleAddrFileInput" style="display:none" accept="image/*,.pdf"
              onchange="handleUIUpload(this, 'soleAddr')">
          </div>

          <div id="soleAddrFileRow"></div>

          <div id="soleAddrForm" style="display:none;">
            <div class="doc-form">
              <div class="doc-form-header">
                <div class="doc-form-title" id="soleAddrFormTitle">Business/Address Proof Details</div>
              </div>
              <div id="soleAddrDynamicFields">
        ...
        <div class="doc-card" id="gstCard">
          <div class="doc-card-head">
            <div class="doc-head-left">
              ...
              <div>
                <div class="doc-title">GST Registration <span class="badge-mandatory">Mandatory</span></div>
          ...
          <div id="gstForm" style="display:none;">
            <div class="doc-form">
              ...
              <div id="gstDynamicFields">
                <div class="form-row"><label class="form-label">GSTIN <span>*</span></label><input class="form-input"
                    type="text" id="gstNumber" placeholder="22AAAAA0000A1Z5" oninput="checkManualReady()"></div>
      ...
      <div class="action-row" style="margin-top: 32px; text-align:center;">
        <button class="btn btn-outline" style="margin-right:12px;" onclick="goTo('screen-upload')">Back</button>
        <button class="btn btn-primary" id="submitManualBtn" onclick="buildReview(); goTo('screen-review')">Continue to
          Verification</button>
      </div>
    </div>
    <!-- ================= SCREEN 4: REVIEW ================= -->
    <div class="screen" id="screen-review">
      ...
      <div class="action-row center">
        <div class="action-row-inner">
          <button class="btn btn-outline" onclick="goTo('screen-manual')">Edit Details</button>
  ...
  <script>
    ...
    <button class="toast-close" onclick="removeToast(this.parentElement)">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="14" height="14"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" y2="18"/></svg>
    </button>`;
    ...
    function simulateUpload(type, fromScan, fileName) {
      ...
      <div class="uploaded-file  ">
        ...
        const typeMap = { shop: 'Shop Establishment', udyam: 'UDYAM Aadhaar' };
        let fields = '';
        if (docType === 'shop') {
          fields = `
        <div class="form-row"><label class="form-label">Certificate Number <span>*</span></label><input class="form-input" type="text" id="addrNum" placeholder="Enter Registration No." oninput="checkManualReady()"></div>
        <div class="form-row" style="margin-bottom:0;"><label class="form-label">State Code <span>*</span></label><input class="form-input" type="text" id="addrState" placeholder="Enter State Code (e.g. KA, DL)" oninput="checkManualReady()"></div>`;
        } else if (docType === 'udyam') {
          fields = `
        <div class="form-row"><label class="form-label">UDYAM Number <span>*</span></label><input class="form-input" type="text" id="addrNum" placeholder="UDYAM-XX-00-0000000" oninput="checkManualReady()"></div>
        <div class="form-row" style="margin-bottom:0;"><label class="form-label">Name as per UDYAM <span>*</span></label><input class="form-input" type="text" id="addrName" placeholder="Enter Business Name" oninput="checkManualReady()"></div>`;
        }
    ...
    function checkManualReady() {
      ...
      let addrFieldsOk = false;
      if (addrUploaded && addrNum) {
        if (addrType === 'shop') addrFieldsOk = !!addrState;
        else if (addrType === 'udyam') addrFieldsOk = !!addrName;
        else addrFieldsOk = true;
      }
      ...
      if (!panUploaded) {
        ...
        btn.disabled = true;
        btn.textContent = 'Upload business/address proof to continue';
      } else if (!addrFieldsOk) {
        btn.disabled = true;
        btn.textContent = 'Complete business/address proof details to continue';
      } else if (!gstUploaded) {
        btn.disabled = true;
    ...
    function buildReview() {
      const addrType = document.getElementById('addrDocType')?.value;
      const typeMap = { 
        aadhaar: 'Aadhaar Card', voter: 'Voter ID', passport: 'Passport', 
        utility: 'Utility Bill', shop: 'Shop Certificate', udyam: 'UDYAM Registration' 
      };
      const addrLabel = typeMap[addrType] || 'Address Proof';

      // Fix: Fetch values directly from DOM to avoid 'undefined' errors
    ...
    <div class="review-card doc-preview-card">
      <div class="dpc-head">
        <div class="dpc-head-left">
          ...
          <div class="dpc-title">Business Certificate</div>
        </div>
        <div class="dpc-check">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><path d="M9 12l2 2 4-4"/></svg>
        </div>
      ...
      <div class="dpc-thumb-lbl">business_certificate.png</div>
      <div class="dpc-fields">
    ...
    function submitKYC() {
      ...
      const kycData = {
        meta: { type: 'sole_proprietor', timestamp: new Date().toISOString() },
        pan: {
          number: document.getElementById('panNumber')?.value,
          name: document.getElementById('panName')?.value,
        },
        address: {
          type: document.getElementById('addrDocType')?.value,
