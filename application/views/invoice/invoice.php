...
<head>
  <meta charset="UTF-8">
  <title>Invoice - <?= $invoice_prefix . sprintf('%03d', $invoice->inv_no); ?></title>
</head>
<body style="font-family: Arial, sans-serif; margin: 40px;">

  <h2 style="text-align: center; margin-bottom: 5px;">Daakit | Invoice</h2>
  <h3 style="text-align: center; margin-top: 0; margin-bottom: 20px;">TAX INVOICE</h3>
  ...
  <table style="width: 100%; font-size: 14px; margin-bottom: 20px;">
    <tr>
      ...
      <td style="width: 33.33%; vertical-align: top;">
        ...
        INVOICE NO:</strong> <?= $invoice_prefix . sprintf('%03d', $invoice->inv_no); ?><br>
        INVOICE DATE:</b> <?= date('d M Y', $invoice->created); ?><br>
        INVOICE PERIOD:</b> <?= ucwords($invoice->month) ?><br><br>
        <table style="
