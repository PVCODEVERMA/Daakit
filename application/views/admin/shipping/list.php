...
<div class="page-header main-container container-fluid px-5">
    ...
    <ol class="breadcrumb d-flex flex-wrap">
        <li class="breadcrumb-item btn-list">
            <a href="javascript:void(0)" target="_blank" class="btn btn-info btn-sm me-2"><i class="fa fa-edit"></i> Edit Payment Type</a>
            <a href="javascript:void(0)" class="btn btn-info btn-sm me-2"><i class="fa fa-edit"></i> Edit Shipment Status </a>
            <a href="javascript:void(0)" class="btn btn-info btn-sm me-2"><i class="fa fa-upload" aria-hidden="true"></i> Bulk NDR Import </a>            
				...
				<div class="chat">
					<div class="contacts_card">
						<div class="input-group p-3">
                            <form method="post" action="<?= base_url('admin/shipping/list') ?>">
                                <div class="row">
                                    <div class="col-md-12">
...
<form id="tab_filter" action="<?php echo base_url('admin/shipping/list');?>" method="POST">
