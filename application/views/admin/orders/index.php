...
<div class="page-header main-container container-fluid px-5">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item btn-list">
            ...
            <a href="<?= base_url('admin/orders/exportCSV');?>" class="btn btn-info btn-sm pull-left display-block mright5" style="margin-right: 10px;"> Export </a>
            <?php } ?>
				...
				<div class="chat">
					<div class="contacts_card">
						<div class="input-group p-3">
                            <form method="post" id="tab_filter" action="<?= base_url('admin/orders/all') ?>">
                                  ...
                                  <tr class="<?php if (@$order->whatsapp_status == 'address_request'){ echo 'table-secondary'; } ?>">
                                      ...
                                      <td>
                                          <?php if ($order->fulfillment_status == 'new') { ?>
                                              ...
                                              <?php } else { ?>
                                                  <button type="button" class="btn btn-outline-success btn-sm" data-order-id='<?= $order->id; ?>' >Get AWB</button>
                                              <?php
                                              }
                                              ?>
                                          <?php
