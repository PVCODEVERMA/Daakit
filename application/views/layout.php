    ...
    <style>
        ...
        * {
        ...
        .recharge-btn:hover {
            ...
            box-shadow: 0 6px 16px rgba(0, 71, 255, .3);
            color: #fff;
        }
    ...
    <div class="page">
                    ...
                    <div class="dropdown-menu">
                        <div style="padding: 10px 16px; border-bottom: 1px solid #E2E8F0; margin-bottom: 4px;">
                            <div style="font-weight:700; font-size: 0.875rem; color: var(--text-dark);">
                                <?php echo $user_details->fname ?? 'Admin'; ?></div>
                            <div style="font-size: 0.75rem; color: var(--text-muted);">
                                <?php echo $user_details->email ?? ''; ?></div>
                        </div>
        ...
        <aside class="app-sidebar" id="sidebar">
            <div class="sidebar-logo">
                <img onclick="window.location.href='<?php echo base_url(); ?>'" class="logo-full cursor-pointer" src="<?php echo base_url(); ?>assets/images/logo-daakit.png" alt="logo">
                <img onclick="window.location.href='<?php echo base_url(); ?>'" class="logo-icon cursor-pointer" src="<?php echo base_url(); ?>assets/images/favicon.png" alt="icon">
            </div>
            ...
            <ul class="side-menu">
                ...
                <!-- Dashboard -->
                <li class="slide">
                    <a class="side-menu__item <?php echo ($this->uri->segment(1) == 'analytics') ? 'active' : ''; ?>"
                ...
                <!-- Orders & Shipments -->
                <li class="slide <?php echo ($this->uri->segment(1) == 'orders') ? 'open' : ''; ?>"
                    ...
                    <div class="side-menu__item <?php echo ($this->uri->segment(1) == 'orders') ? 'active' : ''; ?>">
                        <span class="side-menu__icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                ...
                                <path
                                    d="M6 6l1.5 9m9-9l-1.5 9M6 18a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm12 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4z" />
                            </svg>
                        </span>
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item <?php echo ($this->uri->segment(2) == 'all') ? 'active' : ''; ?>"
                                href="<?php echo base_url('orders/all'); ?>"><i class="fa fa-shopping-cart"></i> All
                                Orders</a></li>
                    </ul>
                </li>
                ...
                <!-- NDR -->
                <li class="slide">
                    <a class="side-menu__item <?php echo ($this->uri->segment(1) == 'ndr') ? 'active' : ''; ?>"
                        href="<?php echo base_url('ndr'); ?>">
                ...
                <!-- Finance -->
                <li class="slide <?php echo ($this->uri->segment(1) == 'billing') ? 'open' : ''; ?>"
                    onclick="toggleSlide(this)">
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="<?php echo base_url('billing/rechage_wallet'); ?>">&#8377;
                                Wallet Recharge</a></li>
                        <li><a class="slide-item" href="<?php echo base_url('billing'); ?>"><i
                                    class="fa fa-file-text"></i> Billing History</a></li>
                        <li><a class="slide-item" href="<?php echo base_url('billing/weight_reconciliation'); ?>"><i
                                    class="fa fa-balance-scale"></i> Weight Reconciliation</a></li>
                    </ul>
                </li>

                <!-- Settings -->
                <li class="slide <?php echo ($this->uri->segment(1) == 'setting' || $this->uri->segment(1) == 'warehouse') ? 'open' : ''; ?>"
                    onclick="toggleSlide(this)">
                    <div
                        class="side-menu__item <?php echo ($this->uri->segment(1) == 'setting' || $this->uri->segment(1) == 'warehouse') ? 'active' : ''; ?>">
                        <span class="side-menu__icon"><i class="fa fa-cogs"></i></span>
                        <span class="side-menu__label">Settings</span>
                        <i class="angle fa fa-angle-right"></i>
                    </div>
                    <ul class="slide-menu">
                        <li><a class="slide-item <?php echo ($this->uri->segment(1) == 'warehouse') ? 'active' : ''; ?>"
                                href="<?php echo base_url('warehouse'); ?>"><i class="fa fa-bank"></i> Warehouse</a>
                        </li>
                        <li><a class="slide-item <?php echo ($this->uri->segment(1) == 'setting') ? 'active' : ''; ?>"
                                href="<?php echo base_url('setting'); ?>"><i class="fa fa-building-o"></i> Company
                                Profile</a></li>
                    </ul>
                </li>
                ...
                <!-- Support -->
                <li class="slide">
                    <a class="side-menu__item <?php echo ($this->uri->segment(1) == 'support') ? 'active' : ''; ?>"
                        href="<?php echo base_url('support'); ?>">
