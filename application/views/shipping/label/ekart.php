...
<footer>
    ...
    <?php } ?>
    <?php if (strtolower($user->support_category) == 'liquidation' || in_array($user->id, [55075,54420,54912,54199,53697,51164,50201,49646,49186,49191,55370])) { ?>
        <b style="font-size:10px;">For any query please contact us at:</b><br />
        <b>Phone:</b> 01140846025
    <?php } else { ?>
