                    ...
                    <?php if (!empty($couriers)) { ?>
                        ...
                        <div class="recommendation-container mt-3">
                            <div class="recommendation-header">
                                <h2><i class="fas fa-robot"></i> Courier Selection</h2>
                                <p class="recommendation-subtitle">Choose from AI predictions or available couriers</p>
                            </div>
                            ...
                            <div class="recommendation-content">
                                <div class="controls">
                                    <div class="tab-container" id="mainTabContainer">
                                        ...
                                        <div class="tab" data-tab="daakitone">
                                            <i class="fas fa-box"></i> Daakit One
                                        </div>
                                        <div class="tab" data-tab="daakitgo">
                                            <i class="fas fa-rocket"></i> Daakit Go
                                        </div>
                                    </div>
                                    
                                    <button class="refresh-btn" id="fetchRecommendations" type="button">
                                        <i class="fas fa-sync-alt"></i> Refresh AI Predictions
                                    </button>
                                </div>
                                ...
                                <div class="results-container active" id="aiResults">
                                    ...
                                    <div class="nested-content active" id="aiAllContent">
                                        <div class="results-header">
                                            <h3 class="results-title"><i class="fas fa-list"></i> All AI Predictions</h3>
                                    ...
                                    <div class="nested-content" id="aiAirContent">
                                        <div class="results-header">
                                            <h3 class="results-title"><i class="fas fa-plane"></i> Air AI Predictions</h3>
                                    ...
                                    <div class="nested-content" id="aiSurfaceContent">
                                        <div class="results-header">
                                            <h3 class="results-title"><i class="fas fa-truck"></i> Surface AI Predictions</h3>
                                ...
                                <div class="results-container" id="daakitoneResults">
                                    <div class="results-header">
                                        <h3 class="results-title"><i class="fas fa-box"></i> Daakit One Couriers</h3>
                                ...
                                <div class="results-container" id="daakitgoResults">
                                    <div class="results-header">
                                        <h3 class="results-title"><i class="fas fa-rocket"></i> Daakit Go Couriers</h3>
...
function getfiltervalue() {
    ...
    if (length > 0 || length2 > 0) {
        ...
        if (activeTab === 'daakitone') {
            filterDaakitOneTable(type_val, check_weight);
        } else if (activeTab === 'daakitgo') {
            filterDaakitGoTable(type_val, check_weight);
...
function createTableRow(courier, rtoAnalysis) {
    ...
    // Extract type and weight from courier data
    const courierType = courier['Courier Name']?.toLowerCase().includes('air') ? 'air' : 'surface';
    const courierWeight = courier['Estimated Weight'] || '500';

    return `
    <tr data-type="${courierType}" data-weight="${courierWeight}">
...
// <td class="tags-cell">
        //     <button type="button" onclick="submitShipment('${courier['Courier Id']}')" class="btn btn-sm btn-primary">Ship Now</button>
        // </td>
// ================= SORTING FUNCTIONS =================
...
function renderAIData(data) {
    ...
    if (data.all && data.all.length > 0) {
        ...
        aiAllCount.textContent = `${data.all.length} of ${data.all.length} couriers`;
    } else {
    ...
    if (data.air && data.air.length > 0) {
        ...
        aiAirCount.textContent = `${data.air.length} of ${data.air.length} couriers`;
    } else {
    ...
    if (data.surface && data.surface.length > 0) {
        ...
        aiSurfaceCount.textContent = `${data.surface.length} of ${data.surface.length} couriers`;
    } else {
