...
<div class="mb-4">
    <p class="text-slate-800 text-lg md:text-xl font-medium">Welcome to DAAKIT, <span class="text-blue-600 font-bold"><?php echo $user_details->fname ?? 'Admin'; ?>!</span></p>
</div>

<!-- ONBOARDING BANNER (TAILWIND UI) -->
<section class="onboard-banner bg-gradient-to-br from-[#0047FF] to-[#1a6aff] rounded-2xl p-5 md:p-6 text-white mb-8 shadow-xl shadow-blue-500/20 flex flex-col gap-3 md:gap-4">
...
<div class="steps-grid">
    ...
    <div class="step-card">
        <div class="card-top">
            ...
            <div class="check-status <?php echo $onboarding_kyc ? 'done' : ''; ?>"></div>
        </div>
    ...
    <div class="step-card">
        <div class="card-top">
            ...
            <div class="check-status <?php echo $onboarding_recharge ? 'done' : ''; ?>"></div>
        </div>
    ...
    <div class="step-card">
        <div class="card-top">
            ...
            <div class="check-status <?php echo $onboarding_warehouse ? 'done' : ''; ?>"></div>
        </div>
    ...
    <div class="step-card">
        <div class="card-top">
            ...
            <div class="check-status <?php echo $onboarding_shipment ? 'done' : ''; ?>"></div>
        </div>
