                    ...
                    <div class="d-lg-flex">
                        <div class="border-end border-bottom bd-lg-b-0 d-flex flex-column mn-wd-20p">
                            <ul class="nav nav-pills main-nav-column p-3">
                                ...
                                <li class="nav-item"><a class="nav-link active"  href="<?php echo base_url('billing/version/seller_invoice');?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Billing Statement</a></li>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                <td><?= (!empty($invoice->invoice_no)) ? $invoice->invoice_no : 'NPPL/' . sprintf('%03d', $invoice->id); ?></td>
