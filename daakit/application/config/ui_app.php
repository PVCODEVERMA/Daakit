...
$config['auth_override_class_method']['auths']['login'] = 'none';
$config['auth_override_class_method']['auths']['authToken'] = 'none';
$config['auth_override_class_method']['auths']['signup'] = 'none';
$config['auth_override_class_method']['auths']['forgot'] = 'none';
$config['auth_override_class_method']['auths']['logout'] = 'none';
$config['auth_override_class_method']['auths']['verifyToken'] = 'none';
$config['auth_override_class_method']['auths']['reset_password'] = 'none';
$config['auth_override_class_method']['Users']['*'] = 'none';
$config['auth_override_class_method']['courier']['*'] = 'none';
$config['auth_override_class_method']['dashboard']['*'] = 'none';
$config['auth_override_class_method']['orders']['*'] = 'none';
$config['auth_override_class_method']['international_orders']['*'] = 'none';
$config['auth_override_class_method']['profile']['*'] = 'none';
$config['auth_override_class_method']['shipments']['*'] = 'none';
$config['auth_override_class_method']['international_shipments']['*'] = 'none';
$config['auth_override_class_method']['warehouse']['*'] = 'none';
$config['auth_override_class_method']['channels']['*'] = 'none';
$config['auth_override_class_method']['billing']['*'] = 'none';
$config['auth_override_class_method']['tags']['*'] = 'none';
$config['auth_override_class_method']['ivrcalls']['*'] = 'none';
$config['auth_override_class_method']['pickups']['*'] = 'none';
$config['auth_override_class_method']['escalations']['*'] = 'none';
$config['auth_override_class_method']['refer']['*'] = 'none';
$config['auth_override_class_method']['billing']['*'] = 'none';
$config['auth_override_class_method']['employees']['*'] = 'none';
$config['auth_override_class_method']['ndr']['*'] = 'none';
$config['auth_override_class_method']['shipping']['*'] = 'none';
$config['auth_override_class_method']['reports']['*'] = 'none';
$config['auth_override_class_method']['weight']['*'] = 'none';
$config['auth_override_class_method']['setting']['*'] = 'none';
$config['auth_override_class_method']['addonapp']['*'] = 'none';
$config['auth_override_class_method']['analytics']['*'] = 'none';

$config['auth_override_class_method']['operation']['*'] = 'none';
$config['auth_override_class_method']['products']['*'] = 'none';
$config['auth_override_class_method']['checkouts']['*'] = 'none';
$config['auth_override_class_method']['bank_verification']['*'] = 'none';

$config['auth_override_class_method']['kyc_verify']['*'] = 'none';





$config['seller_permissions'] = array('orders'=>'Manage Orders','shipments'=>'Manage Shipments','ndr'=>'Manage Exception','weight'=>'Weight Reconciliation','billing'=>'Billing','apps'=>'Addons','settings'=>'Manage Settings','reports'=>'Reports','abandoned_checkouts'=>'Shopify Abandoned');

$config['seller_label_setting'] = array('standard'=>'Standard Desktop Printers - Size A4 (8"X11")','thermal'=>'Thermal Label Printers - Size (4"X6")');
