...
$config['auth_override_class_method']['users']['auth'] = 'none';
...
$config['auth_override_class_method']['shipments2']['*'] = 'none';
...
$config['auth_override_class_method']['hyperlocal']['*'] = 'none';
...
$config['auth_override_class_method']['shipment']['*'] = 'none';
