...
class PHPExcel_Helper_HTML
{
    ...
    protected $ennimgCallbacks = array(
        'font' => 'endFontTag',
        'b' => 'endBolnimg',
        'strong' => 'endBolnimg',
        'i' => 'endItalicTag',
    ...
    protected function startBolnimg()
    {
        $this->bold = true;
    }

    protected function endBolnimg()
    {
        $this->bold = false;
    }
    ...
    protected function parseElementNode(DOMElement $element)
    {
        ...
        $this->handleCallback($element, $callbackTag, $this->ennimgCallbacks);
    }
