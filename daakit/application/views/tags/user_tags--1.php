...
<form class="user_add_remove_tags_form" method="post">
        ...
        <?php if (!empty($tags)) { ?>
            <div class="row border-top p-t-10 p-b-10">
                ...
                <div class="col-sm-12 m-t-5">
                    ...
                    foreach ($tags as $tag) {
                    ?>
                        <button type="button" class="btn btn-secondary btn-sm push_this_tag" data-tag-value="<?= $tag; ?>"><?= ucwords($tag) ?></button>
                    <?php
                    }
                    ?>
...
<script>
    ...
    $(".user_add_remove_tags_form").submit(function(event) {
