...
<table style="width: 100%;border-bottom: 2px solid;">
    <tbody>
        <tr>
            <td style="margin-top: 0px;display: block; width: 50%">
                <p><b>Deliver To:</b></p>
                ...
                <p><?= $order_info->shipping_zip ?> - <b><?= strtoupper($shipment->shipment_info_1) ?> </b></p>
            </td>
            <td style="margin-top: 0px; width:50%; text-align: right; vertical-align: top;">
                <!-- <p><b>Sold By:</b></p>
                <p><b><?= !empty($user->company_name) ?  strtoupper($user->company_name) : ''; ?></b></p>
                <?php if (!empty($company)) {  ?>
                    <p><?= $company->cmp_address; ?></p>
                    <p><?= ucwords($company->cmp_city . ', ' . $company->cmp_state . ' - ' . $company->cmp_pincode); ?></p>
                    <p><b>GST: <?= $company->cmp_gstno; ?></b></p>
                <?php  } ?> -->
        ...
        <tr>
            <td style="width:40%; text-align: center;">
                <?php if (strtolower($order_info->order_payment_type) == 'cod') { ?>
                    <p style="font-size:14px;">Collectable Amount</p>
                    <p style="font-size:18px;">&#8377;<?= round($order_info->order_amount, 2); ?></p>
                <?php } else { ?>
...
<footer>
    ...
    <p><b style="font-size:10px;">Shipped By: MONSTER RETAILS PVT LTD</b><br />
        Plot No. 76D, Phase 4, Udyog Vihar, Gurgoan, Haryana - 122001<br />
        <b>GST: 06AANCM8815D1ZC</b>
    </p> -->
    <div style="width:4.15in;height:0.02in;border-bottom: 1px solid;"></div>
