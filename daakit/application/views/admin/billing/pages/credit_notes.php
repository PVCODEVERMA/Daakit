...
<div class="page-header main-container container-fluid px-5">
    ...
    <ol class="breadcrumb d-flex flex-wrap">
        <li class="breadcrumb-item btn-list">
            <a href="<?= base_url('admin/billing/exportCreditNotes'); ?><?php if (!empty($filter)) {
				...
				<div class="chat">
					<div class="contacts_card">
						<div class="input-group p-3">
                            <form method="post" action="<?= base_url('admin/billing/v/credit_notes'); ?>">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-6" style="margin-top:20px;">
                                        ...
                                        <a href="<?= base_url('admin/billing/v/credit_notes'); ?>" class="btn btn-primary btn-sm">Reset</a>                                
                                    </div>
                                </div>
                            </form>
						</div>
                    ...
                    <div class="d-lg-flex">
                        <div class="border-end border-bottom bd-lg-b-0 d-flex flex-column mn-wd-20p">
                            ...
                            <?php if (in_array('billing_invoices', $user_details->permissions)) { ?>
                                ...
                                <li class="nav-item"><a class="nav-link active"  href="<?php echo base_url('admin/billing/v/credit_notes');?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Credit Memos</a></li>
                            <?php } ?>   
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" data-order-col="2" data-order-type="desc">                    
                                                ...
                                                <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    <td><?= !empty($invoice->legal_name) ? $invoice->legal_name : $invoice->company_name; ?></td>
