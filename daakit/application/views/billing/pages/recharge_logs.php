				...
				<div class="chat">
					<div class="contacts_card">
						<div class="input-group p-3">
                            <form method="post" action="<?= base_url('billing/version/seller_recharge_logs'); ?>">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group no-mbot" app-field-wrapper="Channel[]">
                                            ...
                                            <select class="form-control form-control-sm" name="filter[txn_for]" id="filter_wallet_txn">
                                                ...
                                                <option <?php if ($txn_for == 'ivr_number') { ?> selected="" <?php } ?> value="ivr_number">IVR Number</option>
                                                <option <?php if ($txn_for == 'promotion') { ?> selected="" <?php } ?> value="promotion">Promotion</option>
                                                <option <?php if ($txn_for == 'ivr_call') { ?> selected="" <?php } ?> value="ivr_call">IVR Call</option>
                                                ...
                                                <option <?php if ($txn_for == 'all_communication') { ?> selected="" <?php } ?> value="all_communication">All Communication</option>
                    ...
                    <div class="d-lg-flex">
                        <div class="border-end border-bottom bd-lg-b-0 d-flex flex-column mn-wd-20p">
                            <ul class="nav nav-pills main-nav-column p-3">
                                ...
                                <li class="nav-item"><a class="nav-link  active"  href="<?php echo base_url('billing/version/seller_recharge_logs');?>"><i class="fa fa-inr" aria-hidden="true"></i>Transactions</a></li>
                                            ...
                                            <div class="col-sm-6 col-md-6 action_row_default">
                                                <div class="dataTables_length" id="responsive-datatable_length">
                                                    <div class="btn-group btn-sm ms-auto">
                                                        <button  class="btn btn-sm btn-outline-primary" aria-label="Show unshipped orders">Available Balance : &#8377;<?= !empty($wallet_balance) ? $wallet_balance : '0'; ?></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    TTYPE : <?php
                                                                        ...
                                                                        ?>
                                                                            <a target="blank" class="text-info" href="<?php echo base_url('billing/version/seller_shipping_charges');?>?filter[awb_no]=<?= $his->awb_number; ?>"><?= $his->awb_number; ?></a>
                                                                        <?php
...
$(document).ready(function() {
    $('#retrieveExportBtn').on('click', function() {
        ...
        if (specialChannels.includes(selectedChannel)) {
            ...
            url = "<?= base_url('billing/communications_recharge_logs_export'); ?>?"+formData;
        } else {
            // Call the original backend
            url = "<?= base_url('billing/recharge_logs_export'); ?>?"+formData;
        }
